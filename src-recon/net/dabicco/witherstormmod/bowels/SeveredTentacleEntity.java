...
public class SeveredTentacleEntity extends Entity {
   private static final EntityDataAccessor<Integer> START = SynchedEntityData.defineId(
      net.dabicco.witherstormmod.bowels.SeveredTentacleEntity.class, EntityDataSerializers.INT
   );
   private static final EntityDataAccessor<Integer> COUNT = SynchedEntityData.defineId(
      net.dabicco.witherstormmod.bowels.SeveredTentacleEntity.class, EntityDataSerializers.INT
   );
   private static final EntityDataAccessor<Float> YAW = SynchedEntityData.defineId(
      net.dabicco.witherstormmod.bowels.SeveredTentacleEntity.class, EntityDataSerializers.FLOAT
   );
   ...
   private static final EntityDataAccessor<Float> FROZEN_AT = SynchedEntityData.defineId(
      net.dabicco.witherstormmod.bowels.SeveredTentacleEntity.class, EntityDataSerializers.FLOAT
   );
   private Direction fellUnder;
   private static final EntityDataAccessor<Integer> RESTED = SynchedEntityData.defineId(
      net.dabicco.witherstormmod.bowels.SeveredTentacleEntity.class, EntityDataSerializers.INT
   );
   private static final EntityDataAccessor<Integer> EATER = SynchedEntityData.defineId(
      net.dabicco.witherstormmod.bowels.SeveredTentacleEntity.class, EntityDataSerializers.INT
   );
   ...
   private net.dabicco.witherstormmod.bowels.SeveredRope rope;
   private static final double SUCK = 0.11;
   private static final double SUCK_MAX = 0.32;
   private static final double SWALLOWED = 2.6;

   public SeveredTentacleEntity(EntityType<? extends net.dabicco.witherstormmod.bowels.SeveredTentacleEntity> type, Level level) {
      super(type, level);
   }
   ...
   public Vec3 ropeAnchor(float partialTick) {
      ...
      if (this.rope == null) {
         ...
         Vec3[] prefix = net.dabicco.witherstormmod.bowels.BowelsTentacleShape.path(this.getStart() + 1, this.getScale(), this.ropeJoints());
   ...
   private void ensureRope() {
      if (this.rope == null && this.level().isClientSide()) {
         Vec3[] local = net.dabicco.witherstormmod.bowels.BowelsTentacleShape.path(this.getCount(), this.getScale(), this.joints());
         ...
         this.rope = new net.dabicco.witherstormmod.bowels.SeveredRope(world, this.getDeltaMovement());
      }
   }
   ...
   public float[][] joints() {
      return net.dabicco.witherstormmod.bowels.BowelsTentacleShape.joints(
         ...
         0.0F,
         0.0F,
         (Float)(Object)(Object)this.entityData.get(OPEN),
         (Float)(Object)(Object)this.entityData.get(SWAY)
      );
   }

   public Vec3 cutOffset() {
      Vec3[] whole = net.dabicco.witherstormmod.bowels.BowelsTentacleShape.path(this.getCount(), this.getScale(), this.joints());
   ...
   public void beginSuck(net.dabicco.witherstormmod.bowels.BowelsMawEntity maw) {
      if (!this.level().isClientSide() && (Integer)(Object)(Object)this.entityData.get(EATER) == -1) {
   ...
   public int getEaterId() {
      return (Integer)(Object)(Object)this.entityData.get(EATER);
   }

   private net.dabicco.witherstormmod.bowels.BowelsMawEntity eater() {
      int id = (Integer)(Object)(Object)this.entityData.get(EATER);
      if (id == -1) {
         return null;
   ...
   private void suck(net.dabicco.witherstormmod.bowels.BowelsMawEntity maw) {
      this.noPhysics = true;
      this.entityData.set(RESTED, -1);
   ...
   public int getStart() {
      return (Integer)(Object)(Object)this.entityData.get(START);
   }

   public int getCount() {
      return (Integer)(Object)(Object)this.entityData.get(COUNT);
   }

   public float getYaw() {
      return (Float)(Object)(Object)this.entityData.get(YAW);
   }
   ...
   public float getFrozenAt() {
      return (Float)(Object)(Object)this.entityData.get(FROZEN_AT);
   }

   public boolean isResting() {
      return (Integer)(Object)(Object)this.entityData.get(RESTED) >= 0;
   }
   ...
   public double ropeReach() {
      return net.dabicco.witherstormmod.bowels.BowelsTentacleShape.NATURAL_LENGTH * this.getScale() + 1.0;
   }

   private Vec3 offTheHole(Vec3 motion) {
      if (net.dabicco.witherstormmod.bowels.BowelsFinale.running(this.level().getGameTime())) {
         return motion;
      } else {
         double dx = this.getX() - 177.0;
         double dz = this.getZ() - 0.0;
         ...
         if (d >= clear) {
            ...
            double out = (1.0 - d / clear) * 0.22 + 0.06;
   ...
   public void tick() {
      ...
      double weight = pull == Direction.UP ? 1.0 : -1.0;
      net.dabicco.witherstormmod.bowels.BowelsMawEntity maw = this.eater();
      if (this.level().isClientSide()) {
         this.ensureRope();
         if (this.rope != null) {
         ...
         this.fellUnder = pull;
         if (!this.isResting()) {
            motion = motion.add(0.0, weight * 0.045, 0.0).scale(0.985);
            this.setDeltaMovement(this.offTheHole(motion));
            this.move(MoverType.SELF, this.getDeltaMovement());
            if (this.onGround() || this.verticalCollision) {
               this.setDeltaMovement(this.getDeltaMovement().multiply(0.45, 0.0, 0.45));
   ...
   protected void addAdditionalSaveData(ValueOutput output) {
      ...
      output.putInt("Rested", (Integer)(Object)(Object)this.entityData.get(RESTED));
      output.putFloat("Scale", this.getScale());
      output.putFloat("Open", (Float)(Object)(Object)this.entityData.get(OPEN));
      output.putFloat("Sway", (Float)(Object)(Object)this.entityData.get(SWAY));
   }
}
