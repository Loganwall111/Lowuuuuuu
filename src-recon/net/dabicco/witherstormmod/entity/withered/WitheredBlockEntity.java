...
public class WitheredBlockEntity extends Entity {
   ...
   public boolean isSolid() {
      return (Boolean)(Object)(Object)this.entityData.get(SOLID);
   }
   ...
   public BlockState getBlockState() {
      return Block.stateById((Integer)(Object)(Object)this.entityData.get(BLOCK_ID));
   }
   ...
   public int getOwnerId() {
      return (Integer)(Object)(Object)this.entityData.get(OWNER_ID);
   }

   public boolean isFlung() {
      return (Boolean)(Object)(Object)this.entityData.get(FLUNG);
   }
      ...
      if (this.level() instanceof ServerLevel server) {
         if (!this.isFlung()) {
            ...
            if (var5.hasNext()) {
               ...
               hit.hurtMarked = true;
               this.shatter(server);
            } else if (!this.level().getBlockState(this.blockPosition()).isAir() || this.life > 100) {
               this.shatter(server);
            }
         }
      }
   ...
   protected void addAdditionalSaveData(ValueOutput output) {
      output.putInt("BlockId", (Integer)(Object)(Object)this.entityData.get(BLOCK_ID));
      output.putBoolean("Flung", (Boolean)(Object)(Object)this.entityData.get(FLUNG));
