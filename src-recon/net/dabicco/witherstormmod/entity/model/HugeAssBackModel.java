...
public class HugeAssBackModel extends EntityModel<WitherStormRenderState> {
   ...
   private static PartDefinition make_bone247(PartDefinition param0) {
      return param0.addOrReplaceChild("bone247", CubeListBuilder.create()
            .texOffs(44, 29)
            ...
            .texOffs(44, 29)
            .addBox(136.4151F, 188.3034F, -26.5142F, 7.4078F, 3.7039F, 11.1117F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-20.3056F, -136.5242F, 0.6997F, 0.0F, -1.5708F, 0.0F));
   }
