...
public class SuperSkullRenderer extends EntityRenderer<net.dabicco.witherstormmod.entity.SuperSkullEntity, SuperSkullRenderState> {
   ...
   public void extractRenderState(net.dabicco.witherstormmod.entity.SuperSkullEntity entity, SuperSkullRenderState state, float partialTick) {
