...
public class FurnaceFilterScreen extends AbstractContainerScreen<FurnaceFilterMenu> {
   private static final Identifier BG = Identifier.fromNamespaceAndPath("dabywitherstormmod", "textures/gui/furnace_filter.png");
   ...
   public void extractBackground(GuiGraphicsExtractor g, int mouseX, int mouseY, float partialTick) {
      ...
      int prog = ((FurnaceFilterMenu)(Object)(Object)this.menu).getProgress();
