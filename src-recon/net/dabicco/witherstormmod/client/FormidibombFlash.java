...
public final class FormidibombFlash {
   private static final double FULL_RADIUS = 350.0;
   private static final double SEE_RADIUS = 2000.0;
   ...
   public static void trigger(double x, double y, double z) {
      ...
      if (mc.player != null) {
         ...
         if (!(dist > 350.0)) {
            peakIntensity = Mth.clamp(1.0F - 0.12F * (float)(dist / 350.0), 0.0F, 1.0F);
            lifeTicks = 152.0F;
