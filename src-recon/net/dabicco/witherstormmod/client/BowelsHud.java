...
public final class BowelsHud {
   ...
   public static void render(GuiGraphicsExtractor g, DeltaTracker delta) {
      ...
      if (DabyWSClientConfig.bowelsFrameHud && player != null && client.level != null && BowelsGravity.isBowels(client.level)) {
         ...
         var10000[0] = "BOWELS  of=" + var10003 + "  box=" + box + "  step=" + step;
         ...
         for (int i = 0; i < BowelsTrace.NAMES.length; i++) {
            ...
            if (sample != null) {
               String line = String.format(
                  "%-8s y=%+.4f  z=%+.4f  dy=%+.4f", BowelsTrace.NAMES[i], sample.y, sample.z, previous == null ? 0.0 : sample.y - previous.y
               );
