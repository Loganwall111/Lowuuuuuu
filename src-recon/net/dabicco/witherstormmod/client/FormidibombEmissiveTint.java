...
public record FormidibombEmissiveTint(int light) implements ItemTintSource {
   public static final MapCodec<net.dabicco.witherstormmod.client.FormidibombEmissiveTint> MAP_CODEC = RecordCodecBuilder.mapCodec(
      instance -> instance.group(Codec.INT.optionalFieldOf("light", 0).forGetter(net.dabicco.witherstormmod.client.FormidibombEmissiveTint::light))
         .apply(instance, net.dabicco.witherstormmod.client.FormidibombEmissiveTint::new)
   );
