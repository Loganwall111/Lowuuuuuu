...
/* ================================================================
   3. BLACK HOLES — local lens, never a world replacement
   ================================================================ */
{
  ok('the renderer is a full-screen post-process', /new PostProcess/.test(holeRend));
  ok('no black-hole geometry or private world is constructed',
