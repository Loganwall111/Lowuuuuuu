...
public final class ModEffects {
   ...
   static {
      HYPER_INVISIBILITY = Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, Identifier.fromNamespaceAndPath("dabywitherstormmod", "hyper_invisibility"), new HyperInvisibility());
   }
