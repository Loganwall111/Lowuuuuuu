                        ...
                        if (!(strength <= 0.002F)) {
                           ...
                           if (scene != null && scene.useDepth && scene.getDepthTextureView() != null) {
                              ...
                              try {
                                 ...
                                 Std140Builder.intoBuffer(data).putMat4f(invViewProj).putVec4((float)sun.x, (float)sun.y, (float)sun.z, strength).putVec4((float)DabyWSClientConfig.sunGlowR, (float)DabyWSClientConfig.sunGlowG, (float)DabyWSClientConfig.sunGlowB, 120.0F);
                                 data.rewind();
                                 ...
                                 failed = true;
                                 System.out.println("[dabywitherstormmod] sun glow DISABLED after an error: " + String.valueOf(e));
                                 e.printStackTrace();
                              }
