...
public final class ModPotions {
   ...
   private static Holder<Potion> register(String id, int minutes) {
      return Registry.registerForHolder(BuiltInRegistries.POTION, Identifier.fromNamespaceAndPath("dabywitherstormmod", id), new Potion("hyper_invisibility", new MobEffectInstance[]{new MobEffectInstance(ModEffects.HYPER_INVISIBILITY, minutes * 1200)}));
   }

   public static boolean isHyperInvisibility(Holder<Potion> potion) {
      return potion != null && (potion.value() == HYPER_INVISIBILITY.value() || potion.value() == LONG_HYPER_INVISIBILITY.value() || potion.value() == EXTENDED_HYPER_INVISIBILITY.value());
   }
