...
public final class McsmSiftContent {
    ...
    public static final Block VOID_CRYSTAL = block("void_crystal",
        BlockBehaviour.Properties.of().strength(1.5f, 6f).sound(SoundType.AMETHYST).lightLevel(s -> 12).emissiveRendering((s, l, p) -> true));
    public static final Block VOID_ESSENCE_BLOCK = block("void_essence_block",
        BlockBehaviour.Properties.of().strength(0.8f, 3f).sound(SoundType.GLASS).lightLevel(s -> 10).noOcclusion());
    public static final Block STARLIT_VOID_STONE = block("starlit_void_stone",
        BlockBehaviour.Properties.of().strength(2.5f, 8f).lightLevel(s -> 4).sound(SoundType.DEEPSLATE));
    public static final Block PRISMATIC_CRYSTAL = block("prismatic_crystal",
        BlockBehaviour.Properties.of().strength(1f).lightLevel(s -> 14).sound(SoundType.AMETHYST_CLUSTER).noOcclusion());
    public static final Block NEBULA_BLOCK = block("nebula_block",
        BlockBehaviour.Properties.of().strength(1f, 5f).lightLevel(s -> 11).sound(SoundType.GLASS).noOcclusion());
    public static final Block VOID_FIBER = block("void_fiber",
        BlockBehaviour.Properties.of().strength(0.8f).lightLevel(s -> 6).sound(SoundType.SCULK));
    public static final Block VOID_SPINE = block("void_spine",
        BlockBehaviour.Properties.of().strength(1.5f, 4f).sound(SoundType.BONE_BLOCK).lightLevel(s -> 2));

    // SIFT TIER 1 - GEL HORIZON - floating, god rays, blue/pink grass
    public static final Block SIFT_SPIRE = block("sift_spire",
        BlockBehaviour.Properties.of().strength(1.2f, 6f).lightLevel(s -> 9).sound(SoundType.AMETHYST));
    public static final Block FLOATING_SIFT_STONE = block("floating_sift_stone",
        BlockBehaviour.Properties.of().strength(1.5f, 6f).lightLevel(s -> 3).sound(SoundType.STONE));
    public static final Block GEL_HORIZON_GLASS = block("gel_horizon_glass",
        BlockBehaviour.Properties.of().strength(0.5f).lightLevel(s -> 8).noOcclusion());
    public static final Block LUMEN_MOSS = block("lumen_moss",
        BlockBehaviour.Properties.of().strength(0.2f).lightLevel(s -> 7).sound(SoundType.MOSS));
    ...
    public static final Block MAZE_ORANGE_CORE = block("maze_orange_core",
        BlockBehaviour.Properties.of().strength(2f, 8f).lightLevel(s -> 12).sound(SoundType.STONE));
    public static final Block MAZE_PINK_SHELL = block("maze_pink_shell",
        BlockBehaviour.Properties.of().strength(2f, 8f).lightLevel(s -> 10).sound(SoundType.STONE));
    public static final Block MAZE_VOID_BRICKS = block("maze_void_bricks",
        BlockBehaviour.Properties.of().strength(2.2f, 7f).lightLevel(s -> 1).sound(SoundType.DEEPSLATE_BRICKS));
    public static final Block FRACTAL_SPONGE = block("fractal_sponge",
        BlockBehaviour.Properties.of().strength(1f, 5f).lightLevel(s -> 6).sound(SoundType.SPONGE));

    // SIFT TIER 3 - RIFT FIELD - dark purple neon rifts
    public static final Block RIFT_STONE = block("rift_stone",
        BlockBehaviour.Properties.of().strength(3f, 12f).lightLevel(s -> 5).sound(SoundType.DEEPSLATE));
    public static final Block RIFT_GLASS = block("rift_glass",
        BlockBehaviour.Properties.of().strength(0.5f).lightLevel(s -> 13).sound(SoundType.GLASS).noOcclusion());
    public static final Block NEON_RIFT_VEIN = block("neon_rift_vein",
        BlockBehaviour.Properties.of().strength(0.8f).lightLevel(s -> 15).sound(SoundType.GLASS));
    public static final Block COSMIC_WINDOW = block("cosmic_window",
        BlockBehaviour.Properties.of().strength(0.6f).lightLevel(s -> 8).noOcclusion());

    // SIFT TIER 4 - DISPLACEMENT - rainbow wavy bands
    public static final Block DISPLACEMENT_CRYSTAL = block("displacement_crystal",
        BlockBehaviour.Properties.of().strength(1.8f, 8f).lightLevel(s -> 11).sound(SoundType.AMETHYST));
    public static final Block WAVY_SPACETIME = block("wavy_spacetime",
        BlockBehaviour.Properties.of().strength(0.7f).lightLevel(s -> 9).noOcclusion());
    public static final Block RAINBOW_BAND = block("rainbow_band",
        BlockBehaviour.Properties.of().strength(1.2f).lightLevel(s -> 12).sound(SoundType.STONE));

    // SIFT TIER 5 - IRIDESCENT GEL - rainbow water pools
    public static final Block GEL_CRYSTAL = block("gel_crystal",
        BlockBehaviour.Properties.of().strength(1f, 5f).lightLevel(s -> 13).sound(SoundType.GLASS));
    public static final Block IRIDESCENT_SAND = block("iridescent_sand",
        BlockBehaviour.Properties.of().strength(0.5f).lightLevel(s -> 6).sound(SoundType.SAND));
    public static final Block BLACK_WATER_CRYSTAL = block("black_water_crystal",
        BlockBehaviour.Properties.of().strength(2f, 10f).lightLevel(s -> 3).sound(SoundType.AMETHYST));
    public static final Block GREEN_ACID_CRYSTAL = block("green_acid_crystal",
        BlockBehaviour.Properties.of().strength(1.5f).lightLevel(s -> 9).sound(SoundType.AMETHYST));

    // BOTTOM FABRIC + UNKNOWN - purple pink brown rainbow, bouncy
    public static final Block FABRIC_SHARD = block("fabric_shard",
        BlockBehaviour.Properties.of().strength(2f, 10f).lightLevel(s -> 10).sound(SoundType.AMETHYST));
    public static final Block UNKNOWN_DECAY = block("unknown_decay",
        BlockBehaviour.Properties.of().strength(1f).lightLevel(s -> 4).sound(SoundType.SCULK));
    public static final Block BOUNCY_VOID_MATTER = block("bouncy_void_matter",
        BlockBehaviour.Properties.of().strength(0.8f).lightLevel(s -> 5).sound(SoundType.SLIME_BLOCK).noOcclusion());

    // BLACK HOLE BACKDROP - dynamic skybox blocks
    public static final Block BLACK_HOLE_FRAME = block("black_hole_frame",
        BlockBehaviour.Properties.of().strength(5f, 1200f).lightLevel(s -> 2).sound(SoundType.METAL));
    public static final Block EVENT_HORIZON = block("event_horizon",
        BlockBehaviour.Properties.of().strength(-1f, 3600000f).lightLevel(s -> 1).sound(SoundType.GLASS).noOcclusion());
    public static final Block SINGULARITY_SHARD = block("singularity_shard",
        BlockBehaviour.Properties.of().strength(3f, 20f).lightLevel(s -> 15).sound(SoundType.AMETHYST).emissiveRendering((s,l,p)->true));
    public static final Block LENSED_STARLIGHT = block("lensed_starlight",
        BlockBehaviour.Properties.of().strength(0.3f).lightLevel(s -> 14).noOcclusion().sound(SoundType.GLASS));
