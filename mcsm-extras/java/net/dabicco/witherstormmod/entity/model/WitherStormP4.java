...
public class WitherStormP4 extends EntityModel<WitherStormRenderState> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      if (net.mcsm.extras.McsmExtrasConfig.customMeshModel) {
         ...
         dabyws$buildStageBShellA(mesh);
         dabyws$buildStageBShellB(mesh);
      }
...
PartDefinition bone = root.addOrReplaceChild(
   ...
   private static void dabyws$buildStageBShellA(MeshDefinition mesh) {
      ...
      root.addOrReplaceChild(
         "stageb_sealed_shell_a",
         CubeListBuilder.create()
            .texOffs(0, 0).addBox(-515.6F, -8.1F, 3.8F, 33.0F, 9.0F, 9.0F, new CubeDeformation(0.0F))
            .texOffs(16, 8).addBox(-479.6F, -16.1F, 3.8F, 77.0F, 17.0F, 13.0F, new CubeDeformation(0.0F))
            .texOffs(32, 16).addBox(-467.6F, 3.9F, 3.8F, 65.0F, 1.0F, 13.0F, new CubeDeformation(0.0F))
            .texOffs(48, 24).addBox(-362.2F, -520.9F, 141.9F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(64, 32).addBox(-330.4F, -368.7F, 188.1F, 9.9F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(80, 40).addBox(-334.9F, -308.0F, 160.7F, 11.0F, 8.5F, 7.6F, new CubeDeformation(0.0F))
            .texOffs(96, 48).addBox(-375.7F, -20.1F, -4.1F, 49.0F, 17.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(112, 56).addBox(-399.7F, -20.1F, 3.8F, 73.0F, 21.0F, 17.1F, new CubeDeformation(0.0F))
            .texOffs(128, 64).addBox(-322.1F, 59.8F, -114.5F, 2.8F, 8.5F, 8.2F, new CubeDeformation(0.0F))
            .texOffs(144, 72).addBox(-399.7F, 3.9F, 3.8F, 73.0F, 1.0F, 17.1F, new CubeDeformation(0.0F))
            .texOffs(160, 80).addBox(-295.7F, -520.9F, 51.5F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(176, 88).addBox(-276.4F, -530.9F, 194.9F, 23.4F, 41.1F, 19.1F, new CubeDeformation(0.0F))
            .texOffs(192, 96).addBox(-250.6F, -428.3F, -277.0F, 9.9F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(208, 104).addBox(-317.1F, -428.3F, -186.6F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(224, 112).addBox(-263.1F, -408.9F, 187.4F, 14.5F, 1.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(240, 120).addBox(-277.4F, -449.0F, 334.7F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(256, 128).addBox(-286.1F, -348.0F, -236.3F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(272, 136).addBox(-273.5F, -362.4F, -8.9F, 13.8F, 11.1F, 8.5F, new CubeDeformation(0.0F))
            .texOffs(288, 144).addBox(-316.9F, -398.8F, 187.4F, 68.3F, 41.1F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(304, 152).addBox(-246.5F, -368.7F, 289.6F, 5.6F, 11.0F, 9.9F, new CubeDeformation(0.0F))
            .texOffs(320, 160).addBox(-266.6F, -288.5F, 290.7F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(336, 168).addBox(-302.8F, -148.4F, 2.2F, 11.0F, 8.5F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(352, 176).addBox(-277.1F, -156.6F, 93.0F, 11.0F, 8.5F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(368, 184).addBox(-319.7F, -28.1F, -4.1F, 73.0F, 25.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(384, 192).addBox(-319.7F, -28.1F, 3.9F, 73.0F, 25.0F, 25.0F, new CubeDeformation(0.0F))
            .texOffs(400, 200).addBox(-314.9F, 59.8F, -112.7F, 2.8F, 8.5F, 8.2F, new CubeDeformation(0.0F))
            .texOffs(416, 208).addBox(-319.7F, 3.9F, 3.9F, 73.0F, 1.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(432, 216).addBox(-198.4F, -635.0F, 44.2F, 38.8F, 30.6F, 29.9F, new CubeDeformation(0.0F))
            .texOffs(0, 224).addBox(-185.8F, -544.0F, -39.2F, 17.0F, 49.0F, 33.0F, new CubeDeformation(0.0F))
            .texOffs(16, 232).addBox(-217.8F, -560.0F, 8.8F, 57.9F, 65.0F, 69.5F, new CubeDeformation(0.0F))
            .texOffs(32, 240).addBox(-227.8F, -560.0F, 81.8F, 63.5F, 50.1F, 76.5F, new CubeDeformation(0.0F))
            .texOffs(48, 248).addBox(-182.7F, -428.3F, -210.3F, 21.5F, 11.0F, 44.7F, new CubeDeformation(0.0F))
            .texOffs(64, 256).addBox(-233.2F, -438.3F, -133.7F, 25.3F, 31.1F, 53.9F, new CubeDeformation(0.0F))
            .texOffs(80, 264).addBox(-228.6F, -464.0F, -76.2F, 59.8F, 49.0F, 70.0F, new CubeDeformation(0.0F))
            .texOffs(96, 272).addBox(-217.8F, -480.0F, 8.8F, 49.0F, 65.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(112, 280).addBox(-217.8F, -480.0F, 88.8F, 49.0F, 65.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(128, 288).addBox(-186.3F, -448.0F, 168.8F, 17.5F, 45.5F, 40.9F, new CubeDeformation(0.0F))
            .texOffs(144, 296).addBox(-179.1F, -408.9F, 284.4F, 14.5F, 1.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(160, 304).addBox(-191.6F, -459.1F, 387.6F, 23.4F, 41.1F, 10.1F, new CubeDeformation(0.0F))
            .texOffs(176, 312).addBox(-187.0F, -459.1F, 401.1F, 9.9F, 41.1F, 5.6F, new CubeDeformation(0.0F))
            .texOffs(192, 320).addBox(-218.8F, -388.2F, -236.9F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(208, 328).addBox(-231.3F, -398.2F, -139.4F, 72.1F, 61.2F, 24.8F, new CubeDeformation(0.0F))
            .texOffs(224, 336).addBox(-207.0F, -400.0F, -72.1F, 38.2F, 47.6F, 65.8F, new CubeDeformation(0.0F))
            .texOffs(240, 344).addBox(-239.6F, -400.0F, 8.8F, 70.9F, 49.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(256, 352).addBox(-217.8F, -400.0F, 88.8F, 49.3F, 80.8F, 70.0F, new CubeDeformation(0.0F))
            .texOffs(272, 360).addBox(-184.4F, -400.0F, 161.3F, 18.4F, 57.0F, 46.7F, new CubeDeformation(0.0F))
            .texOffs(288, 368).addBox(-237.5F, -398.8F, 242.5F, 72.9F, 71.2F, 56.4F, new CubeDeformation(0.0F))
            .texOffs(304, 376).addBox(-182.2F, -257.7F, -165.5F, 9.9F, 11.0F, 5.6F, new CubeDeformation(0.0F))
            .texOffs(320, 384).addBox(-222.3F, -317.9F, -156.5F, 54.8F, 71.2F, 71.1F, new CubeDeformation(0.0F))
            .texOffs(336, 392).addBox(-233.6F, -274.9F, -43.5F, 13.8F, 11.1F, 13.6F, new CubeDeformation(0.0F))
            .texOffs(352, 400).addBox(-190.1F, -301.9F, 56.6F, 13.8F, 11.1F, 13.6F, new CubeDeformation(0.0F))
            .texOffs(368, 408).addBox(-224.3F, -318.9F, 82.5F, 64.0F, 76.0F, 42.6F, new CubeDeformation(0.0F))
            .texOffs(384, 416).addBox(-226.5F, -278.4F, 258.9F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(400, 424).addBox(-182.7F, -288.5F, 387.6F, 14.5F, 11.0F, 9.9F, new CubeDeformation(0.0F))
            .texOffs(416, 432).addBox(-208.8F, -225.3F, 91.8F, 36.3F, 23.5F, 60.3F, new CubeDeformation(0.0F))
            .texOffs(432, 440).addBox(-193.5F, -88.6F, -221.2F, 11.0F, 8.5F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0).addBox(-176.3F, -79.1F, -155.0F, 17.1F, 9.0F, 63.9F, new CubeDeformation(0.0F))
            .texOffs(16, 8).addBox(-239.7F, -44.1F, -20.1F, 73.0F, 41.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(32, 16).addBox(-239.7F, -44.1F, 3.9F, 73.0F, 41.0F, 25.0F, new CubeDeformation(0.0F))
            .texOffs(48, 24).addBox(-239.7F, 3.9F, 3.9F, 17.0F, 1.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(64, 32).addBox(-159.2F, -635.0F, 42.6F, 6.7F, 11.0F, 12.1F, new CubeDeformation(0.0F))
            .texOffs(80, 40).addBox(-159.2F, -633.4F, 94.4F, 8.5F, 11.0F, 13.6F, new CubeDeformation(0.0F))
            .texOffs(96, 48).addBox(-153.8F, -544.0F, -79.6F, 65.0F, 59.6F, 73.3F, new CubeDeformation(0.0F))
            .texOffs(112, 56).addBox(-158.5F, -560.0F, 8.1F, 75.9F, 43.2F, 72.5F, new CubeDeformation(0.0F))
            .texOffs(128, 64).addBox(-156.3F, -560.0F, 86.2F, 67.5F, 65.0F, 67.6F, new CubeDeformation(0.0F))
            .texOffs(144, 72).addBox(-121.8F, -503.5F, 168.8F, 41.2F, 8.6F, 56.6F, new CubeDeformation(0.0F))
            .texOffs(160, 80).addBox(-124.7F, -458.4F, -251.3F, 14.5F, 11.0F, 9.9F, new CubeDeformation(0.0F))
            .texOffs(176, 88).addBox(-157.8F, -458.4F, -237.8F, 38.6F, 41.1F, 67.6F, new CubeDeformation(0.0F))
            .texOffs(192, 96).addBox(-153.8F, -464.6F, -113.4F, 73.0F, 49.7F, 34.0F, new CubeDeformation(0.0F))
            .texOffs(208, 104).addBox(-153.8F, -480.0F, -73.8F, 69.8F, 72.8F, 67.6F, new CubeDeformation(0.0F))
            .texOffs(224, 112).addBox(-153.8F, -480.0F, 96.2F, 65.0F, 79.7F, 57.5F, new CubeDeformation(0.0F))
            .texOffs(240, 120).addBox(-153.8F, -480.0F, 168.8F, 74.6F, 65.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(256, 128).addBox(-105.7F, -479.4F, 269.7F, 13.8F, 8.7F, 13.6F, new CubeDeformation(0.0F))
            .texOffs(272, 136).addBox(-155.8F, -400.0F, -140.6F, 67.0F, 78.6F, 54.6F, new CubeDeformation(0.0F))
            .texOffs(288, 144).addBox(-153.8F, -400.0F, -71.2F, 65.0F, 65.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(304, 152).addBox(-153.8F, -368.0F, 8.8F, 65.0F, 37.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(320, 160).addBox(-153.8F, -398.9F, 88.8F, 65.0F, 63.9F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(336, 168).addBox(-153.8F, -400.0F, 168.8F, 65.0F, 49.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(352, 176).addBox(-142.3F, -338.6F, 378.3F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(368, 184).addBox(-116.1F, -280.0F, -211.2F, 11.0F, 8.5F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(384, 192).addBox(-132.9F, -312.4F, -100.5F, 48.3F, 52.9F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(400, 200).addBox(-158.1F, -320.0F, -55.2F, 69.3F, 73.9F, 49.0F, new CubeDeformation(0.0F))
            .texOffs(416, 208).addBox(-144.5F, -320.0F, 8.8F, 55.7F, 79.5F, 71.3F, new CubeDeformation(0.0F))
            .texOffs(432, 216).addBox(-156.1F, -320.0F, 80.7F, 75.6F, 80.0F, 47.8F, new CubeDeformation(0.0F))
            .texOffs(0, 224).addBox(-146.4F, -318.4F, 161.5F, 13.8F, 11.1F, 13.6F, new CubeDeformation(0.0F))
            .texOffs(16, 232).addBox(-142.6F, -278.4F, 355.8F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(32, 240).addBox(-141.5F, -178.5F, -150.8F, 47.1F, 17.1F, 30.8F, new CubeDeformation(0.0F))
            .texOffs(48, 248).addBox(-159.8F, -240.0F, 7.0F, 80.4F, 78.9F, 73.3F, new CubeDeformation(0.0F))
            .texOffs(64, 256).addBox(-145.8F, -239.9F, 80.9F, 43.6F, 79.3F, 41.3F, new CubeDeformation(0.0F))
            .texOffs(80, 264).addBox(-137.1F, -233.2F, 184.0F, 10.0F, 8.5F, 10.0F, new CubeDeformation(0.0F))
            .texOffs(96, 272).addBox(-155.3F, -120.2F, -186.1F, 53.1F, 39.9F, 25.1F, new CubeDeformation(0.0F))
            .texOffs(112, 280).addBox(-157.3F, -159.7F, -152.0F, 77.4F, 76.3F, 66.6F, new CubeDeformation(0.0F))
            .texOffs(128, 288).addBox(-149.1F, -133.7F, -74.3F, 69.5F, 46.1F, 36.0F, new CubeDeformation(0.0F))
            .texOffs(144, 296).addBox(-141.4F, -146.8F, 46.3F, 57.0F, 67.2F, 14.2F, new CubeDeformation(0.0F))
            .texOffs(160, 304).addBox(-151.3F, -159.7F, 87.1F, 50.3F, 24.6F, 36.0F, new CubeDeformation(0.0F))
            .texOffs(176, 312).addBox(-159.2F, -78.2F, -179.9F, 58.2F, 7.7F, 20.8F, new CubeDeformation(0.0F))
            .texOffs(192, 320).addBox(-159.7F, -39.7F, -12.1F, 75.4F, 28.6F, 12.0F, new CubeDeformation(0.0F))
            .texOffs(208, 328).addBox(-159.7F, -73.1F, 3.9F, 75.3F, 70.0F, 56.6F, new CubeDeformation(0.0F))
            .texOffs(224, 336).addBox(-119.7F, 3.9F, 3.9F, 33.0F, 1.0F, 33.0F, new CubeDeformation(0.0F))
            .texOffs(240, 344).addBox(-57.4F, -563.1F, 174.4F, 22.2F, 3.4F, 30.0F, new CubeDeformation(0.0F))
            .texOffs(256, 352).addBox(-73.8F, -528.0F, -39.2F, 65.0F, 33.0F, 33.0F, new CubeDeformation(0.0F))
            .texOffs(272, 360).addBox(-73.8F, -544.0F, 8.8F, 65.0F, 49.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(288, 368).addBox(-73.8F, -528.0F, 104.8F, 33.0F, 33.0F, 49.0F, new CubeDeformation(0.0F))
            .texOffs(304, 376).addBox(-78.1F, -558.4F, 172.9F, 44.7F, 63.5F, 58.5F, new CubeDeformation(0.0F))
            .texOffs(320, 384).addBox(-57.8F, -458.4F, -154.4F, 49.0F, 43.4F, 68.1F, new CubeDeformation(0.0F))
            .texOffs(336, 392).addBox(-78.3F, -480.0F, -77.2F, 73.7F, 73.6F, 51.1F, new CubeDeformation(0.0F))
            .texOffs(352, 400).addBox(-41.8F, -480.0F, 8.8F, 33.0F, 1.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(368, 408).addBox(-73.8F, -480.0F, 88.8F, 65.0F, 65.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(384, 416).addBox(-78.8F, -479.9F, 168.8F, 38.0F, 64.9F, 20.8F, new CubeDeformation(0.0F))
            .texOffs(400, 424).addBox(-41.8F, -392.7F, -114.9F, 17.5F, 57.7F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(416, 432).addBox(-73.8F, -399.1F, -71.2F, 72.4F, 78.4F, 64.8F, new CubeDeformation(0.0F))
            .texOffs(432, 440).addBox(-73.8F, -384.0F, 104.8F, 65.0F, 49.0F, 49.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0).addBox(-73.8F, -384.0F, 168.8F, 65.0F, 49.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(16, 8).addBox(-73.8F, -320.0F, -124.2F, 65.0F, 65.0F, 40.0F, new CubeDeformation(0.0F))
            .texOffs(32, 16).addBox(-73.8F, -304.0F, -71.2F, 71.1F, 53.7F, 70.9F, new CubeDeformation(0.0F))
            .texOffs(48, 24).addBox(-73.8F, -320.0F, 24.8F, 65.0F, 65.0F, 49.0F, new CubeDeformation(0.0F))
            .texOffs(64, 32).addBox(-76.9F, -320.0F, 80.1F, 63.0F, 60.4F, 80.3F, new CubeDeformation(0.0F))
            .texOffs(80, 40).addBox(-52.7F, -304.0F, 160.8F, 53.7F, 65.0F, 29.8F, new CubeDeformation(0.0F))
            .texOffs(96, 48).addBox(-57.8F, -240.0F, -115.3F, 57.3F, 71.8F, 31.4F, new CubeDeformation(0.0F))
            .texOffs(112, 56).addBox(-73.8F, -240.0F, -71.2F, 73.6F, 80.5F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(128, 64).addBox(-76.5F, -240.0F, 8.8F, 74.0F, 67.4F, 71.6F, new CubeDeformation(0.0F))
            .texOffs(144, 72).addBox(-65.8F, -229.3F, 82.8F, 60.8F, 32.2F, 35.3F, new CubeDeformation(0.0F))
            .texOffs(160, 80).addBox(-53.1F, -236.3F, 181.7F, 51.8F, 52.1F, 42.1F, new CubeDeformation(0.0F))
            .texOffs(176, 88).addBox(-80.0F, -160.0F, -127.2F, 55.2F, 67.9F, 45.7F, new CubeDeformation(0.0F))
            .texOffs(192, 96).addBox(-79.5F, -160.0F, -79.3F, 70.7F, 78.6F, 80.3F, new CubeDeformation(0.0F))
            .texOffs(208, 104).addBox(-57.8F, -160.0F, 0.4F, 49.0F, 65.0F, 25.4F, new CubeDeformation(0.0F))
            .texOffs(224, 112).addBox(-63.3F, -137.5F, 84.7F, 39.9F, 37.3F, 61.0F, new CubeDeformation(0.0F))
            .texOffs(240, 120).addBox(-12.1F, -6.5F, -515.1F, 9.0F, 5.0F, 33.0F, new CubeDeformation(0.0F))
            .texOffs(256, 128).addBox(-16.1F, -14.5F, -479.1F, 13.0F, 13.0F, 77.0F, new CubeDeformation(0.0F))
            .texOffs(272, 136).addBox(-20.2F, -18.5F, -399.3F, 17.1F, 17.0F, 73.0F, new CubeDeformation(0.0F))
            .texOffs(288, 144).addBox(-28.2F, -26.5F, -319.3F, 25.0F, 25.0F, 73.0F, new CubeDeformation(0.0F))
            .texOffs(304, 152).addBox(-28.2F, -42.5F, -239.3F, 25.0F, 41.0F, 73.0F, new CubeDeformation(0.0F))
         ,
         PartPose.ZERO);
   }
   /** Build #386: sealed StageB hull part - voxelized from the official traced mesh. */
   ...
   private static void dabyws$buildStageBShellB(MeshDefinition mesh) {
      PartDefinition root = mesh.getRoot();
      root.addOrReplaceChild(
         "stageb_sealed_shell_b",
         CubeListBuilder.create()
            .texOffs(320, 160).addBox(-51.8F, -70.4F, -159.3F, 52.0F, 68.9F, 73.0F, new CubeDeformation(0.0F))
            .texOffs(336, 168).addBox(-71.7F, -80.0F, -79.3F, 72.0F, 78.5F, 79.6F, new CubeDeformation(0.0F))
            .texOffs(352, 176).addBox(-79.7F, -80.0F, 0.2F, 80.7F, 81.0F, 78.8F, new CubeDeformation(0.0F))
            .texOffs(368, 184).addBox(-15.7F, -35.8F, 83.1F, 13.0F, 33.0F, 73.0F, new CubeDeformation(0.0F))
            .texOffs(384, 192).addBox(-23.7F, -43.8F, 160.4F, 21.0F, 41.5F, 75.7F, new CubeDeformation(0.0F))
            .texOffs(400, 200).addBox(-7.7F, -35.8F, 240.4F, 5.0F, 33.5F, 75.7F, new CubeDeformation(0.0F))
            .texOffs(416, 208).addBox(-7.7F, -19.8F, 320.4F, 5.0F, 17.5F, 67.7F, new CubeDeformation(0.0F))
            .texOffs(432, 216).addBox(-12.1F, 1.5F, -487.1F, 9.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
            .texOffs(0, 224).addBox(-16.1F, 1.5F, -479.1F, 13.0F, 5.0F, 77.0F, new CubeDeformation(0.0F))
            .texOffs(16, 232).addBox(-20.2F, 1.5F, -399.3F, 17.1F, 5.0F, 73.0F, new CubeDeformation(0.0F))
            .texOffs(32, 240).addBox(-20.2F, 5.5F, -319.3F, 17.0F, 1.0F, 73.0F, new CubeDeformation(0.0F))
            .texOffs(48, 248).addBox(-20.2F, 5.5F, -239.3F, 17.0F, 1.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(64, 256).addBox(-36.2F, 5.5F, -119.3F, 33.0F, 1.0F, 33.0F, new CubeDeformation(0.0F))
            .texOffs(80, 264).addBox(-63.7F, 0.0F, -79.3F, 60.5F, 22.5F, 79.1F, new CubeDeformation(0.0F))
            .texOffs(96, 272).addBox(-79.7F, 0.0F, 0.2F, 80.5F, 41.4F, 78.8F, new CubeDeformation(0.0F))
            .texOffs(112, 280).addBox(-48.4F, 3.4F, 81.2F, 47.0F, 38.0F, 33.2F, new CubeDeformation(0.0F))
            .texOffs(128, 288).addBox(-7.7F, 4.2F, 323.1F, 5.0F, 1.5F, 33.0F, new CubeDeformation(0.0F))
            .texOffs(144, 296).addBox(1.6F, -613.8F, -131.1F, 40.6F, 30.6F, 31.4F, new CubeDeformation(0.0F))
            .texOffs(160, 304).addBox(30.2F, -612.2F, -79.3F, 13.8F, 11.1F, 13.6F, new CubeDeformation(0.0F))
            .texOffs(176, 312).addBox(36.2F, -526.3F, -159.0F, 44.1F, 30.6F, 58.8F, new CubeDeformation(0.0F))
            .texOffs(192, 320).addBox(6.2F, -544.0F, -41.1F, 74.5F, 49.0F, 34.8F, new CubeDeformation(0.0F))
            .texOffs(208, 328).addBox(6.2F, -544.0F, 8.8F, 65.0F, 49.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(224, 336).addBox(6.2F, -528.0F, 88.8F, 65.0F, 33.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(240, 344).addBox(22.2F, -448.0F, -119.2F, 49.0F, 33.0F, 33.0F, new CubeDeformation(0.0F))
            .texOffs(256, 352).addBox(1.8F, -480.0F, -71.2F, 69.5F, 70.2F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(272, 360).addBox(6.2F, -480.0F, 19.7F, 73.4F, 70.4F, 38.1F, new CubeDeformation(0.0F))
            .texOffs(288, 368).addBox(6.2F, -480.0F, 88.8F, 65.0F, 65.0F, 49.0F, new CubeDeformation(0.0F))
            .texOffs(304, 376).addBox(6.2F, -384.0F, -119.2F, 65.0F, 33.0F, 33.0F, new CubeDeformation(0.0F))
            .texOffs(320, 384).addBox(2.8F, -368.0F, -71.2F, 68.4F, 33.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(336, 392).addBox(51.4F, -397.5F, 8.8F, 19.8F, 62.5F, 49.0F, new CubeDeformation(0.0F))
            .texOffs(352, 400).addBox(6.2F, -400.0F, 88.8F, 65.0F, 65.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(368, 408).addBox(22.2F, -374.6F, 168.8F, 54.8F, 39.6F, 28.0F, new CubeDeformation(0.0F))
            .texOffs(384, 416).addBox(6.2F, -320.0F, -103.2F, 65.0F, 49.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(400, 424).addBox(0.3F, -320.0F, -71.2F, 79.3F, 67.5F, 71.8F, new CubeDeformation(0.0F))
            .texOffs(416, 432).addBox(6.2F, -320.0F, 3.1F, 65.0F, 65.0F, 70.6F, new CubeDeformation(0.0F))
            .texOffs(432, 440).addBox(6.2F, -320.0F, 88.8F, 65.0F, 81.0F, 71.9F, new CubeDeformation(0.0F))
            .texOffs(0, 0).addBox(7.8F, -304.0F, 162.9F, 27.5F, 64.6F, 29.4F, new CubeDeformation(0.0F))
            .texOffs(16, 8).addBox(60.5F, -290.1F, 261.2F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(32, 16).addBox(57.2F, -214.4F, -248.5F, 11.0F, 8.5F, 7.6F, new CubeDeformation(0.0F))
            .texOffs(48, 24).addBox(0.3F, -224.0F, -109.3F, 78.9F, 33.8F, 29.6F, new CubeDeformation(0.0F))
            .texOffs(64, 32).addBox(2.3F, -240.0F, -79.3F, 78.6F, 80.8F, 73.4F, new CubeDeformation(0.0F))
            .texOffs(80, 40).addBox(0.5F, -240.0F, 2.6F, 66.6F, 80.4F, 74.1F, new CubeDeformation(0.0F))
            .texOffs(96, 48).addBox(11.7F, -239.6F, 93.3F, 69.2F, 80.5F, 52.2F, new CubeDeformation(0.0F))
            .texOffs(112, 56).addBox(26.1F, -236.7F, 174.1F, 12.0F, 22.9F, 23.1F, new CubeDeformation(0.0F))
            .texOffs(128, 64).addBox(15.8F, -152.5F, -132.8F, 57.4F, 72.8F, 53.5F, new CubeDeformation(0.0F))
            .texOffs(144, 72).addBox(6.2F, -159.5F, -79.9F, 73.3F, 80.5F, 73.6F, new CubeDeformation(0.0F))
            .texOffs(160, 80).addBox(6.2F, -159.6F, 8.4F, 64.4F, 64.6F, 72.5F, new CubeDeformation(0.0F))
            .texOffs(176, 88).addBox(5.2F, -156.4F, 80.6F, 74.5F, 60.1F, 69.7F, new CubeDeformation(0.0F))
            .texOffs(192, 96).addBox(14.2F, -94.1F, 267.8F, 11.0F, 8.5F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(208, 104).addBox(3.8F, -18.5F, -375.3F, 1.0F, 17.0F, 49.0F, new CubeDeformation(0.0F))
            .texOffs(224, 112).addBox(3.8F, -26.5F, -319.3F, 1.0F, 25.0F, 73.0F, new CubeDeformation(0.0F))
            .texOffs(240, 120).addBox(3.8F, -42.5F, -239.3F, 17.0F, 41.0F, 73.0F, new CubeDeformation(0.0F))
            .texOffs(256, 128).addBox(0.1F, -74.4F, -159.3F, 59.6F, 64.9F, 77.4F, new CubeDeformation(0.0F))
            .texOffs(272, 136).addBox(0.0F, -79.9F, -79.4F, 79.6F, 78.5F, 79.6F, new CubeDeformation(0.0F))
            .texOffs(288, 144).addBox(0.3F, -79.9F, 0.2F, 75.9F, 79.0F, 78.8F, new CubeDeformation(0.0F))
            .texOffs(304, 152).addBox(0.3F, -43.8F, 80.4F, 37.0F, 41.5F, 75.7F, new CubeDeformation(0.0F))
            .texOffs(320, 160).addBox(0.3F, -43.8F, 160.4F, 29.0F, 41.5F, 75.7F, new CubeDeformation(0.0F))
            .texOffs(336, 168).addBox(0.3F, -35.8F, 240.4F, 29.0F, 33.5F, 75.7F, new CubeDeformation(0.0F))
            .texOffs(352, 176).addBox(0.3F, -27.8F, 320.4F, 21.0F, 25.5F, 75.7F, new CubeDeformation(0.0F))
            .texOffs(368, 184).addBox(0.2F, -19.8F, 400.2F, 21.0F, 17.5F, 79.7F, new CubeDeformation(0.0F))
            .texOffs(384, 192).addBox(0.2F, -7.8F, 480.2F, 17.0F, 5.5F, 47.7F, new CubeDeformation(0.0F))
            .texOffs(400, 200).addBox(0.3F, 0.0F, -63.3F, 75.9F, 71.2F, 63.1F, new CubeDeformation(0.0F))
            .texOffs(416, 208).addBox(0.3F, 0.0F, 0.2F, 75.9F, 41.4F, 78.8F, new CubeDeformation(0.0F))
            .texOffs(432, 216).addBox(0.3F, 4.2F, 80.4F, 37.0F, 37.3F, 51.7F, new CubeDeformation(0.0F))
            .texOffs(0, 224).addBox(0.3F, 4.2F, 224.4F, 21.0F, 1.5F, 11.7F, new CubeDeformation(0.0F))
            .texOffs(16, 232).addBox(0.3F, 4.2F, 240.4F, 21.0F, 1.5F, 75.7F, new CubeDeformation(0.0F))
            .texOffs(32, 240).addBox(0.3F, 4.2F, 320.4F, 21.0F, 1.5F, 75.7F, new CubeDeformation(0.0F))
            .texOffs(48, 248).addBox(0.2F, 0.2F, 400.2F, 21.0F, 5.5F, 79.7F, new CubeDeformation(0.0F))
            .texOffs(64, 256).addBox(0.2F, 0.2F, 480.2F, 17.0F, 1.5F, 19.7F, new CubeDeformation(0.0F))
            .texOffs(80, 264).addBox(108.3F, -616.9F, -52.3F, 24.0F, 13.3F, 36.7F, new CubeDeformation(0.0F))
            .texOffs(96, 272).addBox(81.1F, -525.0F, -159.6F, 31.0F, 11.1F, 66.5F, new CubeDeformation(0.0F))
            .texOffs(112, 280).addBox(81.5F, -533.8F, -47.7F, 21.7F, 38.8F, 41.5F, new CubeDeformation(0.0F))
            .texOffs(128, 288).addBox(86.2F, -544.0F, 8.8F, 49.0F, 49.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(144, 296).addBox(134.6F, -532.6F, 262.2F, 23.4F, 41.1F, 19.1F, new CubeDeformation(0.0F))
            .texOffs(160, 304).addBox(86.2F, -448.0F, -141.3F, 65.8F, 33.0F, 61.6F, new CubeDeformation(0.0F))
            .texOffs(176, 312).addBox(86.2F, -480.0F, -77.2F, 70.3F, 75.2F, 70.9F, new CubeDeformation(0.0F))
            .texOffs(192, 320).addBox(80.4F, -480.0F, 8.8F, 78.2F, 79.7F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(208, 328).addBox(102.2F, -480.0F, 88.8F, 54.8F, 65.0F, 71.2F, new CubeDeformation(0.0F))
            .texOffs(224, 336).addBox(86.2F, -400.0F, -151.9F, 51.6F, 62.1F, 65.6F, new CubeDeformation(0.0F))
            .texOffs(240, 344).addBox(86.2F, -400.0F, -71.2F, 74.7F, 80.9F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(256, 352).addBox(86.2F, -397.6F, 7.5F, 73.5F, 77.6F, 72.6F, new CubeDeformation(0.0F))
            .texOffs(272, 360).addBox(86.2F, -400.0F, 88.8F, 65.0F, 65.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(288, 368).addBox(80.6F, -370.4F, 251.8F, 34.7F, 41.1F, 18.2F, new CubeDeformation(0.0F))
            .texOffs(304, 376).addBox(80.3F, -319.7F, -67.6F, 80.2F, 49.9F, 63.0F, new CubeDeformation(0.0F))
            .texOffs(320, 384).addBox(86.2F, -320.0F, 1.2F, 17.3F, 11.3F, 56.5F, new CubeDeformation(0.0F))
            .texOffs(336, 392).addBox(100.6F, -280.0F, 229.4F, 14.5F, 11.0F, 9.9F, new CubeDeformation(0.0F))
            .texOffs(352, 400).addBox(144.4F, -290.1F, 358.1F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(368, 408).addBox(82.1F, -206.1F, -97.4F, 8.1F, 39.7F, 18.4F, new CubeDeformation(0.0F))
            .texOffs(384, 416).addBox(80.4F, -232.7F, -74.3F, 37.0F, 71.7F, 74.5F, new CubeDeformation(0.0F))
            .texOffs(400, 424).addBox(118.3F, -210.6F, 34.5F, 39.8F, 50.4F, 44.1F, new CubeDeformation(0.0F))
            .texOffs(416, 432).addBox(80.0F, -232.2F, 80.8F, 67.5F, 60.3F, 79.7F, new CubeDeformation(0.0F))
            .texOffs(432, 440).addBox(96.8F, -195.6F, 161.1F, 11.3F, 13.6F, 12.1F, new CubeDeformation(0.0F))
            .texOffs(0, 0).addBox(129.9F, -120.7F, -229.7F, 11.0F, 8.5F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(16, 8).addBox(82.1F, -159.8F, -78.1F, 56.6F, 80.0F, 71.0F, new CubeDeformation(0.0F))
            .texOffs(32, 16).addBox(143.4F, -150.4F, 12.1F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(48, 24).addBox(81.4F, -75.6F, -36.3F, 74.9F, 68.8F, 33.0F, new CubeDeformation(0.0F))
            .texOffs(64, 32).addBox(83.2F, -31.8F, 3.7F, 73.0F, 25.0F, 9.0F, new CubeDeformation(0.0F))
            .texOffs(80, 40).addBox(83.2F, 0.2F, -36.3F, 49.0F, 24.2F, 37.2F, new CubeDeformation(0.0F))
            .texOffs(96, 48).addBox(83.2F, 0.2F, 1.4F, 38.3F, 20.9F, 11.5F, new CubeDeformation(0.0F))
            .texOffs(112, 56).addBox(163.8F, -557.8F, -79.5F, 13.8F, 8.7F, 13.6F, new CubeDeformation(0.0F))
            .texOffs(128, 64).addBox(160.6F, -522.5F, 167.9F, 37.2F, 41.1F, 32.2F, new CubeDeformation(0.0F))
            .texOffs(144, 72).addBox(160.1F, -454.4F, -47.6F, 41.2F, 49.5F, 47.4F, new CubeDeformation(0.0F))
            .texOffs(160, 80).addBox(166.2F, -449.7F, 0.3F, 74.2F, 44.9F, 57.5F, new CubeDeformation(0.0F))
            .texOffs(176, 88).addBox(166.2F, -448.0F, 88.8F, 33.0F, 33.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(192, 96).addBox(160.3F, -397.6F, -61.1F, 80.5F, 73.0F, 59.1F, new CubeDeformation(0.0F))
            .texOffs(208, 104).addBox(162.2F, -400.0F, 1.4F, 39.6F, 35.3F, 72.4F, new CubeDeformation(0.0F))
            .texOffs(224, 112).addBox(166.2F, -400.0F, 88.8F, 33.0F, 49.0F, 65.0F, new CubeDeformation(0.0F))
            .texOffs(240, 120).addBox(184.7F, -340.2F, 348.7F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(256, 128).addBox(184.5F, -280.0F, 326.3F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(272, 136).addBox(163.2F, -39.8F, -28.3F, 73.0F, 33.0F, 25.0F, new CubeDeformation(0.0F))
            .texOffs(288, 144).addBox(163.2F, -39.8F, 3.7F, 73.0F, 33.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(304, 152).addBox(165.7F, -29.1F, 196.9F, 11.0F, 8.5F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(320, 160).addBox(179.2F, 0.2F, -20.3F, 57.0F, 9.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(336, 168).addBox(179.2F, 0.2F, 3.7F, 57.0F, 1.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(352, 176).addBox(241.2F, -552.6F, 144.6F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(368, 184).addBox(281.4F, -446.0F, -21.9F, 14.5F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(384, 192).addBox(244.0F, -415.9F, 49.3F, 9.9F, 11.0F, 14.5F, new CubeDeformation(0.0F))
            .texOffs(400, 200).addBox(257.4F, -368.4F, 10.7F, 11.0F, 8.5F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(416, 208).addBox(287.3F, -170.7F, 267.7F, 11.0F, 8.5F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(432, 216).addBox(243.2F, -31.8F, -28.3F, 73.0F, 25.9F, 25.8F, new CubeDeformation(0.0F))
            .texOffs(0, 224).addBox(243.2F, -31.8F, 3.7F, 73.0F, 25.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(16, 232).addBox(243.2F, 0.2F, -20.3F, 73.0F, 9.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(32, 240).addBox(243.2F, 0.2F, 3.7F, 73.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(48, 248).addBox(323.2F, -23.8F, -20.3F, 73.0F, 17.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(64, 256).addBox(323.2F, -15.8F, 3.7F, 65.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(80, 264).addBox(323.2F, 0.2F, -20.3F, 73.0F, 9.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(96, 272).addBox(323.2F, 0.2F, 3.7F, 49.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(112, 280).addBox(403.2F, -15.8F, -20.3F, 76.8F, 13.0F, 17.1F, new CubeDeformation(0.0F))
            .texOffs(128, 288).addBox(403.2F, 0.2F, -20.3F, 76.8F, 9.0F, 17.1F, new CubeDeformation(0.0F))
            .texOffs(144, 296).addBox(483.1F, -3.8F, -16.3F, 45.0F, 1.0F, 13.0F, new CubeDeformation(0.0F))
            .texOffs(160, 304).addBox(483.1F, 0.2F, -16.3F, 45.0F, 5.0F, 13.0F, new CubeDeformation(0.0F))
            .texOffs(176, 312).addBox(561.5F, -229.0F, -47.4F, 11.0F, 8.5F, 11.0F, new CubeDeformation(0.0F))
         ,
         PartPose.ZERO);
   }
