import{S as e}from"./index-DvRDAbgG.js";const t="prePassDeclaration",x=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=x);const b={name:t,shader:x},r="oitDeclaration",g=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=g);const N={name:r,shader:g},a="lightUboDeclaration",w=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=L);const W={name:i,shader:L},o="clusteredLightingFunctions",T=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=T);const H={name:o,shader:T},f="shadowsFragmentFunctions",X=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=X);const U={name:f,shader:X},s="samplerFragmentDeclaration",D=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=D);const G={name:s,shader:D},d="reflectionFunction",I=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=I);const V={name:d,shader:I},n="textureRepetitionFunctions",C=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=C);const k={name:n,shader:C},v="bumpFragmentMainFunctions",E=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=E);const B={name:v,shader:E},l="bumpFragmentFunctions",y=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=y);const Y={name:l,shader:y},c="bumpFragment",P=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=P);const $={name:c,shader:P},h="decalFragment",A=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=A);const q={name:h,shader:A},p="depthPrePass",_=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=_);const Z={name:p,shader:_},u="lightFragment",F=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=F);const j={name:u,shader:F},m="logDepthFragment",M=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=M);const Q={name:m,shader:M},S="oitFragment",R=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=R);const J={name:S,shader:R};export{W as a,G as b,H as c,B as d,Y as e,$ as f,q as g,Z as h,j as i,Q as j,J as k,z as l,N as o,b as p,V as r,U as s,k as t};
