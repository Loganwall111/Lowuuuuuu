import{S as e}from"./index-Cn_j7Ffg.js";const i="bonesDeclaration",s=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=s);const l={name:i,shader:s},n="clipPlaneVertexDeclaration",f=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=f);const u={name:n,shader:f},t="bonesVertex",a=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=a);const m={name:t,shader:a},r="clipPlaneVertex",c=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=c);const o={name:r,shader:c};export{m as a,l as b,u as c,o as d};
