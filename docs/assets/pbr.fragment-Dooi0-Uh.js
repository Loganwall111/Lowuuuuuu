import{S as e}from"./index-jmZ0cpad.js";import{p as Le,o as Ne,l as Te,b as Oe,t as ge,s as he,a as De,c as _e,d as Me,e as Fe,r as Pe,f as Ue,g as be,h as Ge,i as Be,j as ye}from"./oitFragment-DWATmUrq.js";import{s as Ve,m as xe}from"./meshUboDeclaration-Dj0WijUA.js";import{p as He,h as We,a as Xe}from"./harmonicsFunctions-Ch_n6V6w.js";import{m as Ye,l as ke}from"./logDepthDeclaration-DH-b7B0J.js";import{i as we,a as ze}from"./imageProcessingFunctions-D8GQZ7A5.js";import{c as Ke,a as $e}from"./clipPlaneFragment-RAM-rj6a.js";import{f as qe,a as Ze}from"./fogFragment-DS9AnNs7.js";import{h as je}from"./helperFunctions-C4ryUBYl.js";import{d as Je}from"./decalFragment-Die3muc3.js";const r="pbrFragmentExtraDeclaration",x=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=x);const Qe={name:r,shader:x},a="samplerFragmentAlternateDeclaration",H=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=H);const ei={name:a,shader:H},n="pbrFragmentReflectionDeclaration",W=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=W);const ii={name:n,shader:W},f="pbrFragmentSamplersDeclaration",X=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=X);const ri={name:f,shader:X},t="subSurfaceScatteringFunctions",Y=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=Y);const ai={name:t,shader:Y},o="importanceSampling",k=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=k);const ni={name:o,shader:k},c="pbrHelperFunctions",w=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=w);const fi={name:c,shader:w},l="pbrDirectLightingSetupFunctions",z=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=z);const ti={name:l,shader:z},s="pbrDirectLightingFalloffFunctions",K=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=K);const oi={name:s,shader:K},d="hdrFilteringFunctions",$=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=$);const ci={name:d,shader:$},E="pbrBlockReflectance0",q=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=q);const li={name:E,shader:q},u="pbrClusteredLightingFunctions",Z=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=Z);const si={name:u,shader:Z},m="pbrDirectLightingFunctions",j=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=j);const di={name:m,shader:j},S="pbrIBLFunctions",J=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=J);const Ei={name:S,shader:J},v="pbrBlockAlbedoOpacity",Q=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=Q);const ui={name:v,shader:Q},R="pbrBlockReflectivity",ee=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=ee);const mi={name:R,shader:ee},p="pbrBlockAmbientOcclusion",ie=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=ie);const Si={name:p,shader:ie},C="pbrBlockAlphaFresnel",re=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=re);const vi={name:C,shader:re},A="pbrBlockAnisotropic",ae=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=ae);const Ri={name:A,shader:ae},I="pbrBlockReflection",ne=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=ne);const pi={name:I,shader:ne},L="pbrBlockSheen",fe=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=fe);const Ci={name:L,shader:fe},N="pbrBlockClearcoat",te=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=te);const Ai={name:N,shader:te},T="pbrBlockIridescence",oe=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=oe);const Ii={name:T,shader:oe},O="pbrBlockSubSurface",ce=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=ce);const Li={name:O,shader:ce},g="pbrBlockNormalGeometric",le=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=le);const Ni={name:g,shader:le},h="pbrBlockNormalFinal",se=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=se);const Ti={name:h,shader:se},D="pbrBlockLightmapInit",de=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=de);const Oi={name:D,shader:de},_="pbrBlockGeometryInfo",Ee=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=Ee);const gi={name:_,shader:Ee},M="pbrBlockReflectance",ue=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=ue);const hi={name:M,shader:ue},F="pbrBlockDirectLighting",me=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=me);const Di={name:F,shader:me},P="pbrBlockFinalLitComponents",Se=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=Se);const _i={name:P,shader:Se},U="pbrBlockFinalUnlitComponents",ve=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=ve);const Mi={name:U,shader:ve},b="pbrBlockFinalColorComposition",Re=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=Re);const Fi={name:b,shader:Re},G="pbrBlockImageProcessing",pe=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=pe);const Pi={name:G,shader:pe},B="pbrBlockPrePass",Ce=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=Ce);const Ui={name:B,shader:Ce},y="pbrDebug",Ae=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=Ae);const bi={name:y,shader:Ae},V="pbrPixelShader",Ie=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[V]||(e.ShadersStoreWGSL[V]=Ie);const Gi=[Le,Ne,Ve,xe,He,Ye,Qe,Te,Oe,ei,ii,ri,we,Ke,ke,qe,ge,je,ai,ni,fi,ze,he,We,De,ti,oi,Xe,ci,_e,li,si,di,Ei,Me,Fe,Pe,Je,ui,mi,Si,vi,Ri,pi,Ci,Ai,Ii,Li,$e,Ni,Ue,Ti,be,Oi,gi,hi,Di,Ge,_i,Mi,Fi,Be,Ze,Pi,Ui,ye,bi];for(const i of Gi)e.IncludesShadersStoreWGSL[i.name]||(e.IncludesShadersStoreWGSL[i.name]=i.shader);const zi={name:V,shader:Ie};export{zi as pbrPixelShaderWGSL};
