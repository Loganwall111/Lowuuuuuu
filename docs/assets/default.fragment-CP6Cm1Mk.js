import{S as e}from"./index-jmZ0cpad.js";import{s as l,m as s}from"./meshUboDeclaration-Dj0WijUA.js";import{d as c}from"./defaultUboDeclaration-D6QqwvUo.js";import{p as m,o as u,l as d,a as g,c as v,s as p,b as S,r as E,t as C,d as L,e as A,f as R,g as I,h as D,i as T,j as h}from"./oitFragment-DWATmUrq.js";import{m as P,l as N}from"./logDepthDeclaration-DH-b7B0J.js";import{h as _}from"./helperFunctions-C4ryUBYl.js";import{f as O}from"./fresnelFunction-DY_0xj9h.js";import{i as F,a as M}from"./imageProcessingFunctions-D8GQZ7A5.js";import{c as W,a as b}from"./clipPlaneFragment-RAM-rj6a.js";import{f as G,a as x}from"./fogFragment-DS9AnNs7.js";import{d as U}from"./decalFragment-Die3muc3.js";const i="clusteredLightingCompute",f=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=f);const y={name:i,shader:f},o="lightsFragmentFunctions",a=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=a);const V={name:o,shader:a},t="defaultPixelShader",n=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);const w=[l,s,c,m,u,P,_,d,g,v,y,V,p,S,O,E,F,M,C,L,A,W,N,G,b,R,U,I,D,T,x,h];for(const r of w)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const Z={name:t,shader:n};export{Z as defaultPixelShaderWGSL};
