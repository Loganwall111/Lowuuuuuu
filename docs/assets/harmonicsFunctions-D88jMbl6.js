...
#endif
#endif 
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=r);const f={name:a,shader:r},o="harmonicsFunctions",c=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=c);const s={name:o,shader:c};export{f as a,s as h,l as p};
