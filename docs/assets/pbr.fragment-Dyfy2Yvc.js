import{S as e}from"./index-Bo2oqz1j.js";import{p as Le,o as Ne,l as Te,b as Oe,t as ge,s as he,a as De,c as _e,d as Me,e as Fe,r as Pe,g as Ue,f as be,h as Ge,i as Be,j as ye,k as Ve}from"./oitFragment-DqIRqhET.js";import{s as xe,m as He,a as We,l as Xe}from"./logDepthDeclaration-DzBislwJ.js";import{p as Ye,h as ke,a as we}from"./harmonicsFunctions-OpZWqG0J.js";import{i as ze,a as Ke}from"./imageProcessingFunctions-y0S-_EVk.js";import{c as $e,a as qe}from"./clipPlaneFragment-Ccd-lPs3.js";import{f as Ze,a as je}from"./fogFragment-Dr9bGwmj.js";import{h as Je}from"./helperFunctions-Co4J8CLW.js";const r="pbrFragmentExtraDeclaration",x=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
`;e.ShadersStoreWGSL[V]||(e.ShadersStoreWGSL[V]=Ie);const Gi=[Le,Ne,xe,He,Ye,We,Qe,Te,Oe,ei,ii,ri,ze,$e,Xe,Ze,ge,Je,ai,ni,fi,Ke,he,ke,De,ti,oi,we,ci,_e,li,si,di,Ei,Me,Fe,Pe,Ue,ui,mi,Si,vi,Ri,pi,Ci,Ai,Ii,Li,qe,Ni,be,Ti,Ge,Oi,gi,hi,Di,Be,_i,Mi,Fi,ye,je,Pi,Ui,Ve,bi];for(const i of Gi)e.IncludesShadersStoreWGSL[i.name]||(e.IncludesShadersStoreWGSL[i.name]=i.shader);const ki={name:V,shader:Ie};export{ki as pbrPixelShaderWGSL};
