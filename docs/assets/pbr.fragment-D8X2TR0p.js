import{S as e,aa as Oe,ab as ge,ac as Le,D as he,E as De,H as _e,ad as Me,ae as Fe,af as Pe,ag as be,k as Ue,O as Be,l as ye,ah as Ge,t as Ve,ai as He,aj as xe,ak as We,al as Xe,am as Ye,an as ke,ao as we,ap as ze,m as Ke,aq as $e,ar as qe,as as Ze,at as je,n as Je,au as Qe}from"./index-DJ6tNNSK.js";import{p as ei,h as ii,a as ni}from"./harmonicsFunctions-C1NnL2x7.js";const n="pbrFragmentDeclaration",x=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=x);const ai={name:n,shader:x},a="pbrFragmentExtraDeclaration",W=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=W);const oi={name:a,shader:W},o="samplerFragmentAlternateDeclaration",X=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=X);const ti={name:o,shader:X},t="pbrFragmentReflectionDeclaration",Y=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=Y);const ri={name:t,shader:Y},r="pbrFragmentSamplersDeclaration",k=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=k);const fi={name:r,shader:k},f="subSurfaceScatteringFunctions",w=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=w);const ci={name:f,shader:w},c="importanceSampling",z=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=z);const li={name:c,shader:z},l="pbrHelperFunctions",K=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=K);const si={name:l,shader:K},s="pbrDirectLightingSetupFunctions",$=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=$);const di={name:s,shader:$},d="pbrDirectLightingFalloffFunctions",q=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=q);const Ei={name:d,shader:q},E="hdrFilteringFunctions",Z=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=Z);const Ri={name:E,shader:Z},R="pbrDirectLightingFunctions",j=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=j);const ui={name:R,shader:j},u="pbrIBLFunctions",J=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=J);const Ci={name:u,shader:J},C="pbrBlockAlbedoOpacity",Q=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=Q);const mi={name:C,shader:Q},m="pbrBlockReflectivity",ee=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=ee);const Si={name:m,shader:ee},S="pbrBlockAmbientOcclusion",ie=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ie);const Ai={name:S,shader:ie},A="pbrBlockAlphaFresnel",ne=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=ne);const Ii={name:A,shader:ne},I="pbrBlockAnisotropic",ae=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=ae);const vi={name:I,shader:ae},v="pbrBlockReflection",oe=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=oe);const Ni={name:v,shader:oe},N="pbrBlockSheen",te=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=te);const Ti={name:N,shader:te},T="pbrBlockClearcoat",re=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=re);const pi={name:T,shader:re},p="pbrBlockIridescence",fe=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=fe);const Oi={name:p,shader:fe},O="pbrBlockSubSurface",ce=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=ce);const gi={name:O,shader:ce},g="pbrBlockReflectance0",le=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=le);const Li={name:g,shader:le},L="pbrClusteredLightingFunctions",se=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=se);const hi={name:L,shader:se},h="pbrBlockNormalGeometric",de=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=de);const Di={name:h,shader:de},D="pbrBlockNormalFinal",Ee=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Ee);const _i={name:D,shader:Ee},_="pbrBlockLightmapInit",Re=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=Re);const Mi={name:_,shader:Re},M="pbrBlockGeometryInfo",ue=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=ue);const Fi={name:M,shader:ue},F="pbrBlockReflectance",Ce=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Ce);const Pi={name:F,shader:Ce},P="pbrBlockDirectLighting",me=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=me);const bi={name:P,shader:me},b="pbrBlockFinalLitComponents",Se=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=Se);const Ui={name:b,shader:Se},U="pbrBlockFinalUnlitComponents",Ae=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=Ae);const Bi={name:U,shader:Ae},B="pbrBlockFinalColorComposition",Ie=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=Ie);const yi={name:B,shader:Ie},y="pbrBlockImageProcessing",ve=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=ve);const Gi={name:y,shader:ve},G="pbrBlockPrePass",Ne=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=Ne);const Vi={name:G,shader:Ne},V="pbrDebug",Te=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=Te);const Hi={name:V,shader:Te},H="pbrPixelShader",pe=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[H]||(e.ShadersStore[H]=pe);const xi=[Oe,ge,Le,ai,he,De,ei,_e,oi,Me,Fe,Pe,ti,ri,fi,be,Ue,Be,ye,Ge,Ve,ci,li,si,He,xe,ii,We,di,Ei,ni,Ri,ui,Ci,Xe,Ye,ke,we,mi,Si,Ai,Ii,vi,Ni,Ti,pi,Oi,gi,ze,Li,hi,Ke,Di,$e,_i,qe,Mi,Fi,Pi,bi,Ze,Ui,Bi,yi,je,Je,Gi,Vi,Qe,Hi];for(const i of xi)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Yi={name:H,shader:pe};export{Yi as pbrPixelShader};
