...
uniform sampler2D colortex0, colortex1, colortex2, colortex3, colortex4, depthtex0, depthtex1, noisetex, gaux1, gaux2, tex;
...
void main() {
    ...
    mcsm_FragData[0] = vec4(color.rgb, color.a);
}
