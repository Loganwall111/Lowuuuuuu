...
BLOCKS = {
    ...
    # V2 - 30 NEW VOID ECOSYSTEM BLOCKS
    "void_spire": ("cube", "mcsm:block/void_spire"),
    "void_spire_crystal": ("translucent", "mcsm:block/void_spire_crystal"),
    "void_gel": ("cube", "mcsm:block/void_gel"),
    "void_gel_bloom": ("cube", "mcsm:block/void_gel_bloom"),
    "rift_glass_void": ("translucent", "mcsm:block/rift_glass_void"),
    "fracture_stone": ("cube", "mcsm:block/fracture_stone"),
    "fracture_crystal": ("cube", "mcsm:block/fracture_crystal"),
    "abyssal_sand": ("cube", "mcsm:block/abyssal_sand"),
    "luminous_fungus": ("cube", "mcsm:block/luminous_fungus"),
    "void_vines": ("cube", "mcsm:block/void_vines"),
    "gel_horizon_grass": ("cube", "mcsm:block/gel_horizon_grass"),
    "void_blossom_void": ("cube", "mcsm:block/void_blossom_void"),
    "sponge_heart": ("cube", "mcsm:block/sponge_heart"),
    "rift_bloom_void": ("cube", "mcsm:block/rift_bloom_void"),
    "prismatic_void_stone": ("cube", "mcsm:block/prismatic_void_stone"),
    "void_lantern": ("cube", "mcsm:block/void_lantern"),
    "echo_grass": ("cube", "mcsm:block/echo_grass"),
    "void_roots": ("cube", "mcsm:block/void_roots"),
    "abyssal_crystal": ("cube", "mcsm:block/abyssal_crystal"),
    "gel_crystal_void": ("cube", "mcsm:block/gel_crystal_void"),
    "void_moss": ("cube", "mcsm:block/void_moss"),
    "rift_soil": ("cube", "mcsm:block/rift_soil"),
    "fracture_vine": ("cube", "mcsm:block/fracture_vine"),
    "void_berry_bush_void": ("cube", "mcsm:block/void_berry_bush_void"),
    "luminous_sponge": ("cube", "mcsm:block/luminous_sponge"),
    "void_crystal_block": ("cube", "mcsm:block/void_crystal_block"),
    "gel_lantern_void": ("cube", "mcsm:block/gel_lantern_void"),
    "rift_crystal_void": ("cube", "mcsm:block/rift_crystal_void"),
    "prismatic_void_vine": ("cube", "mcsm:block/prismatic_void_vine"),
    "void_shroom": ("cube", "mcsm:block/void_shroom"),
...
NAMES = {
    ...
    "void_spire": "Void Spire",
    "void_spire_crystal": "Void Spire Crystal",
    "void_gel": "Void Gel",
    "void_gel_bloom": "Void Gel Bloom",
    "rift_glass_void": "Rift Glass Void",
    "fracture_stone": "Fracture Stone",
    "fracture_crystal": "Fracture Crystal",
    "abyssal_sand": "Abyssal Sand",
    "luminous_fungus": "Luminous Fungus",
    "void_vines": "Void Vines",
    "gel_horizon_grass": "Gel Horizon Grass",
    "void_blossom_void": "Void Blossom",
    "sponge_heart": "Sponge Heart",
    "rift_bloom_void": "Rift Bloom Void",
    "prismatic_void_stone": "Prismatic Void Stone",
    "void_lantern": "Void Lantern",
    "echo_grass": "Echo Grass",
    "void_roots": "Void Roots",
    "abyssal_crystal": "Abyssal Crystal",
    "gel_crystal_void": "Gel Crystal Void",
    "void_moss": "Void Moss",
    "rift_soil": "Rift Soil",
    "fracture_vine": "Fracture Vine",
    "void_berry_bush_void": "Void Berry Bush",
    "luminous_sponge": "Luminous Sponge",
    "void_crystal_block": "Void Crystal Block",
    "gel_lantern_void": "Gel Lantern Void",
    "rift_crystal_void": "Rift Crystal Void",
    "prismatic_void_vine": "Prismatic Void Vine",
    "void_shroom": "Void Shroom",
