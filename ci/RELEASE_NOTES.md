...
GitHub Actions uploads the built 1.9.102 jar as an artifact from this branch. SHA-256 is emitted next to the artifact and recorded in `out/BUILD_INFO.txt`.
