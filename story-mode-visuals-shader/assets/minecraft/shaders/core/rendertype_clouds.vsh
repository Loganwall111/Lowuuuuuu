// ============================================================================
// STORY MODE VISUALS - cloud module reference listing (EXACT code layout).
//
// This is the cloud alpha-height-fade loop specification provided for this
// project, stored verbatim. The live Iris/Oculus pipeline implements this
// same behavior natively in shaders/gbuffers_clouds.fsh + worldpos.glsl
// (procedural blocky cells, vertical dissolve, celestial color clock).
//
// NOTE: this file is documentation/reference. In 1.20.1 the vanilla pipeline
// renders clouds through position_tex_color_normal (see the fixed
// position_tex_color_normal.fsh in the pack root); the rendertype_clouds
// program below only exists in 1.20.5+ and is not compiled on 1.20.1.
// ============================================================================
#version 150
