...
public class ModEntityModelLayers {
   ...
   public static final ModelLayerLocation WITHER_STORM_P4 = new ModelLayerLocation(
      Identifier.fromNamespaceAndPath("dabywitherstormmod", "wither_storm_p4"), "main"
   );
   public static final ModelLayerLocation WITHER_STORM_DEVOURER = new ModelLayerLocation(
      Identifier.fromNamespaceAndPath("dabywitherstormmod", "wither_storm_devourer"), "main"
   );
   public static final ModelLayerLocation WITHER_STORM_TENTACLES_DEVOURER = new ModelLayerLocation(
      Identifier.fromNamespaceAndPath("dabywitherstormmod", "wither_storm_tentacles_devourer"), "main"
   );
   ...
   public static final ModelLayerLocation WITHER_STORM_HEAD = new ModelLayerLocation(
      Identifier.fromNamespaceAndPath("dabywitherstormmod", "wither_storm_head"), "main"
   );
   public static final ModelLayerLocation WITHER_STORM_HEAD_GLOW = new ModelLayerLocation(
      Identifier.fromNamespaceAndPath("dabywitherstormmod", "wither_storm_head_glow"), "main"
   );
   public static final ModelLayerLocation WITHER_STORM_HEAD_EYE_GLOW = new ModelLayerLocation(
      Identifier.fromNamespaceAndPath("dabywitherstormmod", "wither_storm_head_eye_glow"), "main"
   );
   public static final ModelLayerLocation WITHER_STORM_GROWTH5 = new ModelLayerLocation(
      Identifier.fromNamespaceAndPath("dabywitherstormmod", "wither_storm_growth5"), "main"
   );
   public static final ModelLayerLocation WITHER_STORM_TENTACLES5 = new ModelLayerLocation(
      Identifier.fromNamespaceAndPath("dabywitherstormmod", "wither_storm_tentacles5"), "main"
   );
   ...
   public static final ModelLayerLocation SEVERED_WITHER_STORM = new ModelLayerLocation(
      Identifier.fromNamespaceAndPath("dabywitherstormmod", "severed_wither_storm"), "main"
   );
