...
public class GrappledTntRenderer extends EntityRenderer<GrappledTntEntity, GrappledTntRenderer.State> {
   ...
   public void extractRenderState(GrappledTntEntity entity, GrappledTntRenderer.State state, float partialTick) {
      ...
      if (ex instanceof Entity) {
         double exx = Mth.lerp((double)partialTick, entity.xOld, entity.getX());
         double ey = Mth.lerp((double)partialTick, entity.yOld, entity.getY());
         double ez = Mth.lerp((double)partialTick, entity.zOld, entity.getZ());
