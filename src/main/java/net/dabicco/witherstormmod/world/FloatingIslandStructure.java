...
/** Registry-backed procedural floating-island structure type. */
public class FloatingIslandStructure extends Structure {
   ...
   public FloatingIslandStructure(StructureSettings settings) { super(settings); }
   @Override protected Optional<GenerationStub> findGenerationPoint(GenerationContext context) { return Optional.empty(); }
   @Override public StructureType<?> type() { return ModWorldgen.FLOATING_ISLAND; }
}
