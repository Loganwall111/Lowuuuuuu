...
public final class StormStarfield {
   ...
   public static void submit(LevelRenderContext ctx) {
      ...
      // teal wash once any nearby storm is feeding the phase-5 turquoise palette
      float teal = StormPalettes.strength() * Mth.clamp((float)((StormSkyDarken.palettePhase() - 4.6) / 0.8), 0.0F, 1.0F) * 0.6F;
