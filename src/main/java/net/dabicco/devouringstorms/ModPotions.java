...
public final class ModPotions {
   ...
   private static Holder<Potion> register(String id, int minutes) {
      return Registry.registerForHolder(BuiltInRegistries.POTION, Identifier.fromNamespaceAndPath("devouringstorms", id), new Potion("hyper_invisibility", new MobEffectInstance[]{new MobEffectInstance(ModEffects.HYPER_INVISIBILITY, minutes * 1200)}));
   }
