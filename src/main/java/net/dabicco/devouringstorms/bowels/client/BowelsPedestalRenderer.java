...
import net.dabicco.devouringstorms.bowels.BowelsPedestalEntity;
...
public class BowelsPedestalRenderer extends EntityRenderer<BowelsPedestalEntity, BowelsPedestalRenderer.State> {
