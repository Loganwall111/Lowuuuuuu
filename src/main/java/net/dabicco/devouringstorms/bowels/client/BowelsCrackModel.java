...
public final class BowelsCrackModel {
   public static final ModelLayerLocation LAYER = new ModelLayerLocation(Identifier.fromNamespaceAndPath("devouringstorms", "bowels_crack"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      float out = 8.06F;
      float[][] pose = new float[][]{{0.0F, 0.0F, -out, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, out, 0.0F, (float)Math.PI, 0.0F}, {out, 0.0F, 0.0F, 0.0F, ((float)Math.PI / 2F), 0.0F}, {-out, 0.0F, 0.0F, 0.0F, (-(float)Math.PI / 2F), 0.0F}, {0.0F, -out, 0.0F, ((float)Math.PI / 2F), 0.0F, 0.0F}, {0.0F, out, 0.0F, (-(float)Math.PI / 2F), 0.0F, 0.0F}};

      for(int i = 0; i < 6; ++i) {
         float[] p = pose[i];
         root.addOrReplaceChild("face" + i, CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -8.0F, 0.0F, 16.0F, 16.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(p[0], p[1], p[2], p[3], p[4], p[5]));
      }
