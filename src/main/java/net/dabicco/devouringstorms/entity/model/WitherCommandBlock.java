...
import net.dabicco.devouringstorms.entity.animation.WitherCommandBlockAnim;
...
public class WitherCommandBlock extends EntityModel<WitherStormRenderState> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath("devouringstorms", "wither_storm"), "main");
