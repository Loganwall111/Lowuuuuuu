package net.dabicco.devouringstorms.entity.animation;
...
public final class PhaseStormAnim {
   ...
   public static float strength() { return DevouringStormsClientConfig.phaseAnim ? (float)DevouringStormsClientConfig.phaseAnimStrength : 0.0F; }
