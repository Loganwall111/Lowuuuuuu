...
import net.dabicco.devouringstorms.entity.StormHeadHost;
...
public class WitherStormHeadRenderer extends EntityRenderer<WitherStormHeadEntity, WitherStormHeadRenderState> {
   ...
   public static int glowTint() {
      int r = (int)(Mth.clamp(DevouringStormsClientConfig.eyeColorR, 0.0, 1.0) * 255.0);
      int g = (int)(Mth.clamp(DevouringStormsClientConfig.eyeColorG, 0.0, 1.0) * 255.0);
      int b = (int)(Mth.clamp(DevouringStormsClientConfig.eyeColorB, 0.0, 1.0) * 255.0);
      r = (int)((float)r * 0.96F);
   ...
   public static int eyeTint() {
      int r = (int)(Mth.clamp(DevouringStormsClientConfig.beamColorR, 0.0, 1.0) * 255.0);
      int g = (int)(Mth.clamp(DevouringStormsClientConfig.beamColorG, 0.0, 1.0) * 255.0);
      int b = (int)(Mth.clamp(DevouringStormsClientConfig.beamColorB, 0.0, 1.0) * 255.0);
   ...
   private static float jawLagGain() {
      return (float)DevouringStormsClientConfig.jawLagGain;
   }

   private static float jawLagMax() {
      return (float)DevouringStormsClientConfig.jawLagMax;
   }

   private static float jawLagCatchup() {
      return (float)DevouringStormsClientConfig.jawLagCatchup;
   }
   ...
   public void extractRenderState(WitherStormHeadEntity entity, WitherStormHeadRenderState state, float partialTick) {
      ...
      boolean legacy = DevouringStormsClientConfig.legacyHeads;
   ...
   public void submit(WitherStormHeadRenderState state, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, CameraRenderState camera) {
      ...
      float emit = (float)Mth.clamp(DevouringStormsClientConfig.glowStrength, 0.0, 1.0) * state.lit;
      if (emit > 0.02F) {
         submitNodeCollector.submitModel(
            this.glowModel,
            state,
