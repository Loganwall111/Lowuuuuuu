      ...
      if (enabled && reports < 8) {
         ...
         if (w > 0 && h > 0) {
            ...
            try {
               ...
               System.out.println("[devouringstorms][diag] readback failed: " + String.valueOf(e));
            }
      ...
      try {
         ...
         label100: {
            try {
               ...
               ++reports;
               String tag = "[devouringstorms][diag] ";
               if (emitters == 0) {
         ...
         System.out.println("[devouringstorms][diag] map failed: " + String.valueOf(e));
      }
   }
