...
public final class TractorBeamRenderer {
   ...
   private static int beamR() {
      return (int)(Mth.clamp(DevouringStormsClientConfig.beamColorR, (double)0.0F, (double)1.0F) * (double)255.0F);
   }

   private static int beamG() {
      return (int)(Mth.clamp(DevouringStormsClientConfig.beamColorG, (double)0.0F, (double)1.0F) * (double)255.0F);
   }

   private static int beamB() {
      return (int)(Mth.clamp(DevouringStormsClientConfig.beamColorB, (double)0.0F, (double)1.0F) * (double)255.0F);
   }
   ...
   public static void submitBeam(PoseStack poseStack, SubmitNodeCollector collector, Vec3 apex, Vec3 relEnd, float groundRadius, float timeTicks, float beamScale) {
      ...
      float opacity = (float)Mth.clamp(DevouringStormsClientConfig.beamOpacity, (double)0.0F, (double)2.0F);
      int alpha = (int)(50.0F * pulse * opacity);
      if (alpha > 1) {
         int topAlpha = Math.min(255, alpha + (int)(30.0F * opacity));
         float endFade = (float)Mth.clamp(DevouringStormsClientConfig.beamEndFade, (double)0.0F, (double)1.0F);
   ...
   private static void emitWalls(PoseStack.Pose pose, VertexConsumer consumer, Vec3[] top, Vec3[] bottom, int topAlpha, int alpha, int r, int g, int b) {
      for(int i = 0; i < 4; ++i) {
         ...
         if (DevouringStormsClientConfig.beamInnerFaces) {
   ...
   public static void submitPreviewMotes(PoseStack poseStack, SubmitNodeCollector collector, Vec3 apex, Vec3 relEnd, float groundRadius, float timeTicks, float beamScale) {
      ...
      float alpha = (float)Mth.clamp(DevouringStormsClientConfig.beamOpacity, (double)0.0F, (double)1.0F);
      if (!(alpha <= 0.01F)) {
