...
public final class StormFog {
   ...
   public static float fogScale() {
      if (!DevouringStormsClientConfig.stormFog || DevouringStormsClientConfig.stormFogStrength <= 0.0) {
         return 1.0F;
      }
      ...
      float scale = (float)(1.0 - (double)t * DevouringStormsClientConfig.stormFogStrength);
