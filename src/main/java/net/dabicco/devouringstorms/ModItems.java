...
import net.dabicco.devouringstorms.item.FormidibombItem;
...
public class ModItems {
   ...
   public static <T extends Item> T register(String name, Function<Item.Properties, T> itemFactory, Item.Properties settings) {
      ResourceKey<Item> itemKey = ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath("devouringstorms", name));
   ...
   static {
      FORMIDIBOMB = register("formidibomb", FormidibombItem::new, (new Item.Properties()).stacksTo(16).component(DataComponents.ITEM_NAME, Component.translatable("item.devouringstorms.formidibomb").withStyle(Style.EMPTY.withColor(TextColor.fromRgb(10170623)))).component(DataComponents.LORE, new ItemLore(List.of(Component.translatable("item.devouringstorms.formidibomb.lore").withStyle(ChatFormatting.GRAY), Component.translatable("item.devouringstorms.formidibomb.warning").withStyle(new ChatFormatting[]{ChatFormatting.RED, ChatFormatting.BOLD})))));
      FURNACE_FILTER = register("furnace_filter", (props) -> new BlockItem(ModBlocks.FURNACE_FILTER, props), (new Item.Properties()).component(DataComponents.LORE, new ItemLore(List.of(Component.translatable("item.devouringstorms.furnace_filter.lore").withStyle(ChatFormatting.GRAY)))));
